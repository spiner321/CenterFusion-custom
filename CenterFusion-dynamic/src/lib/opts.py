...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default='', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='./models/centernet_baseline_e170.pth',
    ...
    self.parser.add_argument('--val_split', default='val',
                             choices=['val_norm','val_abnorm','test', 'test_norm', 'test_abnorm'])
  ...
  def parse(self, args=''):
    ...
    # log dirs
    opt.root_dir = os.path.join(os.getcwd())
